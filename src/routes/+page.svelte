...
<JDGContentContainer overlapWithHeader={true} topBottomPadding="0" gap="0">
	...
	<JDGContentBoxFloating>
		<JDGBodyCopy>
			The <strong>Cinderella City Project</strong> is an immersive look at a unique mid-century shopping destination,
			...
			<br /><br />
			From concept to layout to construction, Cinderella City was an unconventional experiment in mixed-use
			development, and its short but explosive 30-year life provides lessons in retail design, land use,
			and placemaking.
		</JDGBodyCopy>
		<JDGGridLayout>
			<JDGImageTile
		...
		<JDGBodyCopy>
			The <strong>Cinderella City Project</strong> aims to document Cinderella City as an architectural artifact -
			from a detailed history, to an anatomical analysis, to a fully-fledged interactive simulation.
			<br /><br />
