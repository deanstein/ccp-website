...
<JDGContentContainer>
	<JDGContentBoxFloating title="SHORT HISTORY" isForBodyCopy={true}>
		...
		closed with just one store left. The City of Englewood redeveloped the mall in 1998, resulting in
		a new transit-oriented open-air development called CityCenter.
		<br /><br />
		Cinderella City is being brought back to life virtually as an interactive exhibit known as The Cinderella
		City Project - an accurate simulation of the mall which transports visitors back in time to the mall’s
		two distinct periods: 1968-1987, and 1988-1997.
		<span>
